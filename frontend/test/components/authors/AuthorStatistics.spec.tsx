...
describe(AuthorStatistics, () => {
  ...
  it("displays the count of channels with videos the author has commented on", () => {
    ...
    expect(commentedChannels).toHaveTextContent(`${author.author_statistics?.channel_count}`);
  ...
  it("displays the count of videos the author has commented on", () => {
    ...
    expect(commentedVideos).toHaveTextContent(`${author.author_statistics?.video_count}`);
  ...
  it("displays the total number of comments the author has made", () => {
    ...
    expect(totalComments).toHaveTextContent(`${author.author_statistics?.comment_count}`);
  ...
  it("displays the total number of replies the author has made", () => {
    ...
    expect(totalReplies).toHaveTextContent(`${author.author_statistics?.reply_count}`);
