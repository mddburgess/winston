...
public abstract class ChannelEntityMapper {
    ...
    @Mapping(target = "uploadsPlaylistId", source = "contentDetails.relatedPlaylists.uploads")
    @Mapping(target = "viewCount", source = "statistics.viewCount")
    @Mapping(target = "subscriberCount", source = "statistics.subscriberCount")
    @Mapping(target = "videoCount", source = "statistics.videoCount")
